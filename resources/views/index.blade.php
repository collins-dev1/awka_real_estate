...
<body>
    ...
    <section class="hero" id="home">
        ...
        <div class="hero-content">
            ...
            <p>The government-recognized platform for verified real estate agents in Anambra State. Fight fraud, verify
    ...
    <section class="features" id="features">
        ...
        <div class="features-grid">
            <div class="feature-card">
                ...
                <p>Complete registration system with membership ID, verification badges, digital ID cards, and QR codes
                    for instant verification.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">🔍</div>
                <h3>Agent Verification</h3>
                <p>Public tool to verify any agent's status - Active, Suspended, Banned, or Not Registered. Fight fraud
                    effectively.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">📊</div>
                <h3>Agent Dashboard</h3>
                <p>Manage profile, renew membership, pay dues, list properties, and access constitution and guidelines.
                </p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">🏘️</div>
                <h3>Property Marketplace</h3>
                <p>Only verified agents can list properties. Landlords can submit properties for agents to manage
                    safely.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">🏢</div>
                <h3>Landlord Portal</h3>
                <p>Verify agents, list properties, choose approved agents, report fraud, and track property management.
                </p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">⚖️</div>
                <h3>Constitution & Rules</h3>
                <p>Access association constitution, rules, regulations, disciplinary procedures, and membership
                    requirements.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">💳</div>
                <h3>Payment System</h3>
                <p>Secure payments for registration, renewals, ID cards, and fines via Paystack/Flutterwave with
                    automatic receipts.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">🎓</div>
                <h3>Training & Certification</h3>
                <p>Online courses on property laws, fraud prevention, and real estate ethics with official certificates.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="cta">
        <div class="cta-content">
            ...
            <p>Become a verified member of the Real Estate Agents Association and gain access to exclusive tools,
                training, and a trusted network. Help us regulate the industry and fight fraud.</p>
